...
begin
  ...
  select req_org,r.req_tocode into vOrg,vStore from r5requisitions r where req_code = rql.rql_req;
...
exception 
  ...
  when others then 
    RAISE_APPLICATION_ERROR ( -20003, 'Processing error in Flex/r5requislines/Insert/210/'||SQLCODE || SQLERRM) ;
end;