...
or (evt_org in ('ACW','NWA','TAS','VIC','WAR','WAU','SAU','NSW','QLD','NTE','NVE','NVW','NVP') and evt_class not in ('PS','CO','BD','RF','OP'))
or (org_curr = 'NZD' and evt_org not in ('STA','ACW') 
    and evt_class not in ('PS','CN','CO','MO','RF','RN','OP','BD'))
or (org_curr = 'AUD' and evt_org not in ('WRR','QGC','HWC','BAR','PKM','ALC','BPK','BRK','MMO','SYN','NWA','TAS','VIC','WAR','WAU','SAU','NSW','QLD','NTE','NVE','NVW','NVP') 
