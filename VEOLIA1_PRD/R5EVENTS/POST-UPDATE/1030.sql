...
or (evt_org in ('ACW','TAS','VIC','WAR','WAU','NWA','SAU','NSW','QLD','NTE','NVE','NVP','NVW','NVQ','FCG') and evt_class not in ('PS','CO','BD','RF','OP'))
or (org_curr = 'NZD' and evt_org not in ('STA','ACW') 
    and evt_class not in ('PS','CN','CO','MO','RF','RN','OP','BD'))
or (org_curr = 'AUD' and evt_org not in ('WRR','QGC','HWC','BAR','PKM','ALC','BPK','BRK','MMO','SYN','TAS','VIC','WAR','WAU','NWA','SAU','NSW','QLD','NTE','NVE','NVP','NVW','NVQ','FCG') 
