...
BEGIN 
  ...
  IF EVT.EVT_FAILURE is NULL AND EVT.EVT_TYPE != 'MEC' AND EVT.EVT_CLASS IN ('BD','CO') AND EVT.EVT_STATUS IN ('51SO','50SO','49MF','48MR','65RP','55CA','C') 
     AND (
   (EVT.EVT_ORG IN ('BEN','BAL','GSP','ROS','GER','WYU','BAR','BGW','BTT','BRK','EPT','WCC','WCR','GCD','WOO','RRM','HWC','KUR','TTB','WLT','WEW','SPR','SBW', 'CFA','QGC','NPA','CGC','SPF','EAS','OWN'))
   OR 
  ...
  END IF;
/*
IF EVT.EVT_ORG IN ('BEN','BAL','GSP','ROS','GER','WYU','BAR','BGW','BTT','EPT','WCC','WCR','GCD','WOO','RRM','HWC','KUR','TTB','WLT','WEW','SPR','SBW', 'CFA','QGC','NPA','CGC','SPF','EAS','OWN')
