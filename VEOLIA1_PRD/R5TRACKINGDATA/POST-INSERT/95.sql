...
*/
DELETE FROM R5TRADERATES
      WHERE TRR_ORG = C1.TKD_PROMPTDATA1
         AND TRR_TRADE = C1.TKD_PROMPTDATA2
         AND TRR_MRC = C1.TKD_PROMPTDATA3
         AND TRR_PERSON = C1.TKD_PROMPTDATA4
         AND TRR_OCTYPE = C1.TKD_PROMPTDATA5
         AND TRR_START = TO_DATE(C1.TKD_PROMPTDATA6, 'YYYY-MM-DD')
         AND TRR_END = TO_DATE(C1.TKD_PROMPTDATA7, 'YYYY-MM-DD')
         AND TRR_NTRATE = C1.TKD_PROMPTDATA8;
/*
