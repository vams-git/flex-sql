...
VPA R5ORGANIZATIONOPTIONS%ROWTYPE;
chk VARCHAR2(3);
imsg varchar2(400);
err exception;
...
*/
  SELECT * INTO VPA FROM R5ORGANIZATIONOPTIONS
  WHERE OPA_ORG = '*' AND OPA_CODE = C1.TKD_PROMPTDATA2;
  UPDATE R5ORGANIZATIONOPTIONS
  SET OPA_COMMENT = VPA.OPA_COMMENT
