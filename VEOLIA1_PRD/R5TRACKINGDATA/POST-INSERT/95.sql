...
if c1.tkd_trans = 'MPPZ' then 
  UPDATE R5EVENTS
  SET EVT_MP_ORG = C1.TKD_PROMPTDATA2,
  EVT_MP = C1.TKD_PROMPTDATA3,
  EVT_MP_REV = C1.TKD_PROMPTDATA4,
  EVT_SEQ = C1.TKD_PROMPTDATA5,
  EVT_STANDWORK = C1.TKD_PROMPTDATA6,
  EVT_PSQPK = C1.TKD_PROMPTDATA7
  WHERE  EVT_CODE = C1.TKD_PROMPTDATA1;
/*
